...
(define x (begin (display 3)(newline)(+ 4 5)))
; expect 3; x
...
(define (s param1 param2) (> param1 param2))
; expect s

s
; expect (lambda (param1 param2) (> param1 param2))
...
(f #f)
; expect Error: operand 0 (False) is not a number

(f 5)
; expect 6

(f 1 2 3)
; exepct Error: too many arguments
...
(cond (False 1) (else False))
; expect False

(cond ((and False True) (display 5))
      (False  (print 5)))
; expect 
...
(let ((hilfinger 1)
      ((denero hilfinger))
      (print denero)))
; expect Error: bad bindings list in let form 
...
(define f (mu (x y) (let ((y x)) y)))
; expect f

(f 1 2)
; expect 1

(define WHY (lambda (x) (f x y)))
;expect why
...
(enumerate '(2 4 6 8 10))
; expect ((0 2) (1 4) (2 6) (3 8) (4 10))

(enumerate '(nil 2 8))
; expect ((0 ()) (1 2) (2 8))

(enumerate '(2 False True))
; expect ((0 2) (1 False) (2 True))

(list-change 0 '(12 11 10))
; expect ((12))

(list-change -11 '(11 10))
; expect ()

(list-change 28 '(20 3 2))
; expect ((20 3 3 2) (20 2 2 2 2) (3 3 3 3 3 3 3 3 2 2) (3 3 3 3 3 3 2 2 2 2 2) (3 3 3 3 2 2 2 2 2 2 2 2) (3 3 2 2 2 2 2 2 2 2 2 2 2) (2 2 2 2 2 2 2 2 2 2 2 2 2 2))

(list-change 10 '(5 4 3))
; expect ((5 5) (4 3 3))
...
(let-to-lambda '(quote (let ((c 10) (b 15)) (/ a b))))
; expect (quote (let ((c 10) (b 15)) (/ a b)))

(let-to-lambda '(lambda (x) a (let ((a x)) a)))
; expect (lambda (x) a ((lambda (a) a) x))

(let-to-lambda '(let ((x 9)) (* x x)))
; expect ((lambda (x) (* x x)) 9)

(let-to-lambda '(define (square x) (* x x)))
...
(quote (quote (quote Paralyzed)))
; expect (quote (quote paralyzed))

(eval (quote (quote (quote Paralyzed))))
; expect (quote paralyzed)
